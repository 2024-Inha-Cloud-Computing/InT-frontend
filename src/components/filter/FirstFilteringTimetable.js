        ...
        >
            <SwiperSlide>
                <div className='fflt_theader'>
                    ...
                    <img src={isLiked ? blue_heart : gray_heart} onClick={handleToggle} className="fflt_heart" />
                </div>
                <div className="fflt_content">시간표 1</div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='fflt_theader'>
                ...
                <div className="fflt_content">시간표 2</div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='fflt_theader'>
                ...
                <div className="fflt_content">시간표 3</div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='fflt_theader'>
                ...
                <div className="fflt_content">시간표 4</div>
            </SwiperSlide>
        </Swiper>
        <button className="fflt_nextButton" onClick={goNext}>다음으로 넘어가기</button>
      </div>
    );
  };
