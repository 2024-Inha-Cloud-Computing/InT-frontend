...
const SndFilLikeProf = () => {
    ...
    const courses = [
      ...
      { id: 3, name: '컴퓨터공학과, 운영체제, CSE2345', professors: ['교수 4', '교수 5', '교수 6'] },
      { id: 4, name: '컴퓨터공학과, 컴퓨터구조론, CSE7896', professors: ['교수 7', '교수 8', '교수 9'] },
      { id: 5, name: '컴퓨터공학과, 컴퓨터구조론, CSE7896', professors: ['교수 7', '교수 8', '교수 9'] },
      { id: 6, name: '컴퓨터공학과, 컴퓨터구조론, CSE7896', professors: ['교수 7', '교수 8', '교수 9'] },
    ];
